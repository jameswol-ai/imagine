...
MODULE_SPECS: tuple[ModuleSpec, ...] = (
    ...
    ModuleSpec("Architectural Design Handbook", "Architectural Design Handbook", "ARCHITECTURE", "architecture.standards.architectural_handbook", "render_architectural_handbook", True),
    ...
    ModuleSpec("EN 1990", "EN 1990", "STRUCTURAL", EUROCODE_SUITE, "render", True),
    ModuleSpec("EN 1991", "EN 1991", "STRUCTURAL", EUROCODE_SUITE, "render", True),
    ModuleSpec("EN 1992", "EN 1992", "STRUCTURAL", EUROCODE_SUITE, "render", True),
    ModuleSpec("EN 1993", "EN 1993", "STRUCTURAL", EUROCODE_SUITE, "render", True),
    ModuleSpec("EN 1994", "EN 1994", "STRUCTURAL", EUROCODE_SUITE, "render", True),
    ModuleSpec("EN 1995", "EN 1995", "STRUCTURAL", EUROCODE_SUITE, "render", True),
    ModuleSpec("EN 1996", "EN 1996", "STRUCTURAL", EUROCODE_SUITE, "render", True),
    ModuleSpec("EN 1997", "EN 1997", "STRUCTURAL", EUROCODE_SUITE, "render", True),
    ModuleSpec("EN 1998", "EN 1998", "STRUCTURAL", EUROCODE_SUITE, "render", True),
    ModuleSpec("EN 1999", "EN 1999", "STRUCTURAL", EUROCODE_SUITE, "render", True),
    ...
    ModuleSpec("Elements", "Elements", "BIM", FALLBACK, "render", True),
    ModuleSpec("IFC", "IFC", "BIM", "modules.bim.ifc_export", "render", True),
    ModuleSpec("COBie", "COBie", "BIM", FALLBACK, "render", True),
    ModuleSpec("BIM Digital Twin", "BIM Digital Twin", "BIM", FALLBACK, "render", True),
