...
MODULE_SPECS: tuple[ModuleSpec, ...] = (
    ...
    ModuleSpec("Transformers", "Transformers", "MEP", None, "render", False),
    ModuleSpec("Generators", "Generators", "MEP", None, "render", False),
    ModuleSpec("Cable Sizing", "Cable Sizing", "MEP", None, "render", False),
    ModuleSpec("Solar PV", "Solar PV", "MEP", None, "render", False),
    ...
    ModuleSpec("Variations", "Variations", "CONSTRUCTION", "modules.construction.submittals", "render", True),
    ...
    ModuleSpec("Reports", "Reports", "DOCUMENTS", None, "render", False),
