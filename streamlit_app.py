...
st.Page routing, dynamic sidebar searching, transparent glassmorphism UI,
interactive button navigation, and complete module registry coverage.
"""
...
# ============================================================================
# GLOBAL STYLING: TRANSPARENT SIDEBAR, BUTTON NAVIGATION & CUSTOM LOGO
# ============================================================================
...
st.markdown(
    ...
    <style>
        ...
        [data-testid="stSidebar"] {
            background: rgba(18, 22, 31, 0.45) !important;
        ...
        /* --- INTERACTIVE BUTTON NAVIGATION FOR SIDEBAR --- */
        ...
        div[data-testid="stSidebarNav"] a[aria-current="page"] {
            background: linear-gradient(135deg, rgba(59, 130, 246, 0.28), rgba(37, 99, 235, 0.45)) !important;
...
# ============================================================================
# COMPLETE ENTERPRISE MODULE REGISTRY (NO EMOJIS)
# ============================================================================
...
MODULE_REGISTRY: list[ModuleMeta] = [
    ...
    ModuleMeta("authorization", "Authorization", "CORE & PLATFORM", "Role-based access control policies.", "core.authorization.ui", "render_authorization"),
    ...
    ModuleMeta("approvals", "Approvals", "PROJECTS", "Stage-gate approval workflows and sign-offs.", "projects.approvals.ui", "render_approvals"),
    ...
    ModuleMeta("governance", "Governance", "PROJECTS", "Enterprise governance and compliance metrics.", "projects.governance.ui", "render_governance"),
    ...
    ModuleMeta("zoning", "Zoning Analysis", "ARCHITECTURE", "Zoning envelope and FAR calculations.", "architecture.zoning.ui", "render_zoning"),
    ...
    # --- BIM & OPEN BIM ---
    ModuleMeta("bim_buildings", "Buildings", "BIM & IFC", "BIM model building hierarchy and metadata.", "bim.buildings.ui", "render_buildings"),
    ...
    ModuleMeta("en1993", "Eurocode 3 (EN 1993)", "STRUCTURAL DESIGN", "Design of steel structures.", "structural.eurocode.en1993.ui", "render_en1993"),
    ...
    ModuleMeta("en1997", "Eurocode 7 (EN 1997)", "STRUCTURAL DESIGN", "Geotechnical design and soil parameters.", "structural.eurocode.en1997.ui", "render_en1997"),
    ...
    ModuleMeta("column_design", "Column Design", "STRUCTURAL DESIGN", "Axial and biaxial column capacity checks.", "structural.column_design.ui", "render_column_design"),
    ModuleMeta("slab_design", "Slab Design", "STRUCTURAL DESIGN", "One-way, two-way, and flat slab design.", "structural.slab_design.ui", "render_slab_design"),
    ...
    ModuleMeta("fea", "Finite Element Analysis", "STRUCTURAL DESIGN", "2D/3D structural mesh solver and stress analysis.", "structural.finite_element_analysis.ui", "render_fea"),

    # --- MEP ENGINEERING ---
    ModuleMeta("hvac", "HVAC Design", "MEP ENGINEERING", "Cooling/heating load estimation and duct sizing.", "mep.mechanical.hvac.ui", "render_hvac"),
    ModuleMeta("ventilation", "Ventilation Systems", "MEP ENGINEERING", "Airflow rates and mechanical ventilation design.", "mep.mechanical.ventilation.ui", "render_ventilation"),
    ...
    ModuleMeta("energy_simulation", "Building Energy Simulation", "MEP ENGINEERING", "Thermal performance and energy compliance.", "mep.mechanical.energy_simulation.ui", "render_energy_simulation"),
    ...
    ModuleMeta("solar_pv", "Solar PV Systems", "MEP ENGINEERING", "Rooftop solar sizing, yield, and storage.", "mep.electrical.solar_pv.ui", "render_solar_pv"),
    ...
    ModuleMeta("stormwater", "Stormwater Management", "MEP ENGINEERING", "Runoff calculations and attenuation tanks.", "mep.plumbing.stormwater.ui", "render_stormwater"),
    ...
    ModuleMeta("procurement", "Procurement & Bidding", "COSTING & QUANTITY SURVEYING", "Contractor bid comparison and schedules.", "costing.procurement.ui", "render_procurement"),
    ...
    ModuleMeta("construction_planning", "Site Logistics Planning", "CONSTRUCTION SITE", "Tower crane coverage and site layout.", "construction.planning.ui", "render_construction_planning"),
    ...
    # --- DOCUMENT MANAGEMENT ---
    ModuleMeta("drawing_management", "Drawing Register", "DOCUMENTS", "CAD/BIM drawing revisions and issuance.", "documents.drawing_management.ui", "render_drawing_management"),
    ...
    ModuleMeta("version_control", "Version Control", "DOCUMENTS", "Document revision tracking and diffs.", "documents.version_control.ui", "render_version_control"),
    ...
    ModuleMeta("vector_store", "Vector Store", "IMAGINE AI ASSISTANTS", "Building code and technical embedding storage.", "ai.vector_store.ui", "render_vector_store"),
    ...
    ModuleMeta("zoning_laws", "Zoning Master Directory", "REGIONAL CODES", "Municipal setbacks, height limits, and FAR.", "regional.zoning_laws.ui", "render_zoning_laws"),
    ...
    ModuleMeta("integration_revit", "Autodesk Revit", "INTEGRATIONS", "BIM model bidirectional synchronization.", "integrations.revit.ui", "render_revit"),
    ModuleMeta("integration_archicad", "Graphisoft ArchiCAD", "INTEGRATIONS", "OpenBIM exchange with ArchiCAD.", "integrations.archicad.ui", "render_archicad"),
    ...
    ModuleMeta("integration_azure", "Azure Cloud Services", "INTEGRATIONS", "Cloud compute and storage endpoints.", "integrations.azure.ui", "render_azure"),
    ModuleMeta("integration_mapbox", "Mapbox Maps", "INTEGRATIONS", "3D terrain and satellite location rendering.", "integrations.mapbox.ui", "render_mapbox"),
    ...
    ModuleMeta("dt_maintenance", "Predictive Maintenance", "DIGITAL TWIN & IOT", "Equipment failure predictions and service logs.", "digital_twin.maintenance.ui", "render_maintenance"),
...
def render_overview() -> None:
    ...
    st.write(
        ...
        "Use the sidebar navigation buttons or search bar above to access architectural design engines, structural Eurocode solvers, "
...
def render_system_health() -> None:
    ...
    if st.session_state.imagine_renderer_errors:
        ...
        for key, err_info in st.session_state.imagine_renderer_errors.items():
            ...
            with st.expander(f"System Notice: {label}", expanded=False):
...
base_pages_dict["SYSTEM"] = [
    st.Page(render_system_health, title="System Health", url_path="system-health"),
]

# ============================================================================
# SIDEBAR HEADER, CUSTOM LOGO & DYNAMIC NAVIGATION FILTER
# ============================================================================
    ...
    st.markdown(
        ...
        <div class="brand-wrapper">
            <svg class="brand-logo-svg" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="10" y="10" width="80" height="80" rx="16" stroke="#3B82F6" stroke-width="6" fill="rgba(59, 130, 246, 0.08)" />
                <path d="M30 70 L50 30 L70 70" stroke="#60A5FA" stroke-width="6" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M38 54 L62 54" stroke="#93C5FD" stroke-width="5" stroke-linecap="round" />
                <circle cx="50" cy="30" r="4" fill="#3B82F6" />
                <line x1="20" y1="80" x2="80" y2="80" stroke="#3B82F6" stroke-width="4" stroke-linecap="round" />
            </svg>
            <div>
...
if search_query:
    ...
    if filtered_pages_dict:
        ...
        st.sidebar.caption("No matching modules found.")
        pg = st.navigation(base_pages_dict)
else:
    pg = st.navigation(base_pages_dict)

# Execute native routing (renders interactive sidebar navigation buttons & selected module)
pg.run()
...
with st.sidebar:
    ...
    st.markdown(
        ...
        <div class="imagine-user-panel">
            <div class="imagine-user-name">User: {st.session_state.imagine_user}</div>
